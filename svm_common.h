...
public:
    ...
    long kernel_id; /* Feature vectors with different
     ...
     implemented). */
    SVECTOR *next; /* Let's you set up a list of SVECTOR's
...
void read_documents(FILE *, DOC ***, double **, long *, long *);
int parse_document(char *, WORD *, double *, long *, long *, double *, long *,
                   long, char **);
int parse_document(FILE *, WORD *, double *, long *, long *, double *, long *,
                   long, char **);
double *read_alphas(char *, long);
void nol_ll(char *, long *, long *, long *);
void nol_ll(FILE*, long *, long *, long *);
long minl(long, long);
long maxl(long, long);
